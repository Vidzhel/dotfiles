...
-- lvim.builtin.lualine.extensions = true

lvim.builtin.which_key.mappings["w"] = {
  name = "+Window",
  h = { "<cmd>sp<cr>", "Horizontal stplit" },
  ...
  K = { "<C-w>K", "Move up" },
  J = { "<C-w>J", "Move down" },
  x = { "<C-w>x", "Exchange with next" },
}
lvim.builtin.which_key.mappings["w"]["="] = { "<C-w>=", "Vertical split" }
lvim.builtin.which_key.mappings["w"][">"] = { "<C-w>>", "Increase with" }
lvim.builtin.which_key.mappings["w"]["<"] = { "<C-w><", "Decrease with" }
lvim.builtin.which_key.mappings["w"]["+"] = { "<C-w>+", "Increase height" }
lvim.builtin.which_key.mappings["w"]["-"] = { "<C-w>-", "Decrease height" }
...
--   {
--     command = "codespell",
--     ---@usage specify which filetypes to enable. By default a providers will attach to all the filetypes it supports. filetypes = { "javascript", "python" },
--   },
-- }
